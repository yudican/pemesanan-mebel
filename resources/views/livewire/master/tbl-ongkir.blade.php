                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>ongkir</span>
                        </a>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <x-text-field type="text" name="nama" label="Jenis" />
                        <x-text-field type="number" name="ongkir" label="Ongkir" />
                    </div>
